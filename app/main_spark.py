...
def get_spark_session() -> SparkSession:
    ...
    spark_session = SparkSession \
        ...
        .config("spark.mongodb.read.connection.uri", "mongodb://172.22.0.2:27017/myapp.historic") \
        .config("spark.mongodb.write.connection.uri", "mongodb://172.22.0.2:27017/myapp.historic") \
